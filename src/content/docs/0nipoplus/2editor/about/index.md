...
編集者（または管理者）はグループ内における日報テンプレートの管理など、グループ内のあらゆる設定を行うことができます。
グループ内の設定はすべて、「グループ設定」セクションにまとまっています。

![グループ設定は編集者権限以上で表示される](./img/group-manage_tablet.png)
...
現在の作業グループは画面上部のバーに表示されています。複数のグループに所属している場合は切替ボタンも表示されます

:::caution[所属グループが1つの場合は表示されません]
:::
...
![グループの切り替えは画面左上のスイッチから行う](./img/switch_tablet.png)
