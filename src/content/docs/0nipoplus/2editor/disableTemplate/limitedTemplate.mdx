...
<TopicGrid>
  ...
  <AutoTopicCard title="フォルダ分け" href="/nipoplus/template/directory" />
</TopicGrid>
...
## テンプレート制限機能の目的とメリット [#id=limit-purpose]
...
## 利用可能なテンプレートを設定する [#id=limitUsageTemplate]
...
## 制限は日報作成時にのみ適用されます [#id=limitInfo]
