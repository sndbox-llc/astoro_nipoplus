...
![カレンダーモードでは日報の提出日や枚数が月単位で俯瞰できる](./img/calendar_tablet.webp)
...
## 月カレンダーに切り替える {#calendar_switch_month}

カレンダーの表示モードを「月」に切り替えることで１ヶ月間の日報や予定を月カレンダーで確認できます。

![月カレンダーでは予定と日報がカレンダー上に表示される](./img/monthly-calendar_tablet.webp)

## 月カレンダーの各種設定 {#calendar_settings_month}
...
![カレンダーから日報を表示するとポップアップで表示される](./img/read-report_tablet.webp)

## 月カレンダから予定を登録する {#add_event_month}
...
## 週カレンダーに切り替える {#calendar_switch_week}
...
![3日とか10日とか自由に選べる](./img/weekly-calendar_tablet.webp)

## 週カレンダーの各種設定 {#calendar_settings_week}
...
![週カレンダーから予定をポップアップで表示した例](./img/show-event_tablet.webp)

## カレンダから予定を登録する {#add_event_about}
...
## 表カレンダーに切り替える {#calendar_switch_map}

カレンダーの表示モードを「表」に切り替えることで、スタッフごとの日報や予定を一目で確認できます。スタッフ別の進捗状況や業務配分の確認に最適です。

![「スタッフ」を軸に据えた格子状の表](./img/table-calendar_tablet.webp)

表カレンダーは縦軸にスタッフ、横軸に日付の格子状のカレンダーです。

## 表カレンダーの各種設定 {#calendar_settings_map}
...
![同セル内の日報や予定が１つの塊として表示される](./img/pagination_tablet.webp)

## 表カレンダから予定を登録する {#add_event_map}
...
## 日カレンダーの各種設定 {#calendar_settings_day}
...
## 日カレンダーから予定を登録する {#add_event_day}

時間軸上でドラッグすることで指定範囲に対して予定を追加できます。
スマートフォンの場合、スクロールとドラッグの動きが同じため少しコツが要ります。
スマートフォンでは、時間軸に指をおいて1秒ほどホールドし、「ドラッグ可能」と表示が出たらドラッグを開始します。

![時間軸上をドラッグして予定を追加可能。スマホの場合は「ホールド」して「スワイプ」する](./img/add-eventday_tablet.webp)
