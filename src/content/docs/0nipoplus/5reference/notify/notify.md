...
![右上のベルアイコンをクリックして通知を確認します](./img/notify_tablet.png)
...
![通知のON.OFFは利用者ごとに個別に変更できます](./img/email-notice_tablet.png)
...
![メール通知の上限を緩和するにはオプション費用が必要です](./img/unlock_tablet.png)
...
<dd><div>申し訳ございません。オプションに関してはクレジットカードによる支払いをお願いしています。どうしてもカードが使用できない環境の場合、個別に請求書で対応させていただくこともあります。詳しくは<a href="/inquery/">お問い合わせ</a>ください</div></dd>
