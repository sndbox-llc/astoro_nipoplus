...
![Emailとパスワードを入力してログインします](./img/signin_tablet.webp)
...
![左メニューから「アカウント」をクリックしてログインE-mailや権限を確認できます](./img/account_tablet.webp)
...
![ボタンやメニューは翻訳されますが自作の項目は翻訳されません](./img/i18n_tablet.webp)
