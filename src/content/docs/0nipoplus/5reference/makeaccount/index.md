...
![組織内に新しいスタッフのアカウントを追加します](./img/create-new-staff_tablet.png)
...
![複数のスタッフアカウントをまとめて作成できます](./img/webp_tablet.webp)
...
![ログインできない共用アカウントは、特定の共有環境でのみ使われる特殊な用途です。](./img/anony_tablet.png)
...
![状態ボタンを1回クリックすると無効化、もう1回クリックすると有効に戻ります。](./img/disable-account_tablet.png)
