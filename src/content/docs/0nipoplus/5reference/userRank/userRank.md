...
- [グループの作成・削除](/docs/admin/about/)
- [スタッフの作成・削除](/docs/reference/makestaff/)
- スタッフの権限変更
...
- [日報提出先の指定（グループ内）](/docs/editor/destinationlock/)
...
詳しくは[グループ設定](/docs/editor/groupmanage/)を御覧ください。
...
- [日報の作成・編集](/docs/staff/writereport/)
- 他のスタッフが書いた日報の閲覧・集計
- 提出された日報の承認（権限があれば）
...
:::caution[ゲスト権限は現在非推奨]
上位互換となる[外部入力機能](/docs/reference/outsidewrite/)がサポートされたため、ゲスト権限を使用するメリットは現在ありません。
:::
...
しかし前述の通りログインすら不要でアンケート回答に使える[外部入力機能](/docs/reference/outsidewrite/)の登場により、この権限は静かに役目を終えようとしています。
