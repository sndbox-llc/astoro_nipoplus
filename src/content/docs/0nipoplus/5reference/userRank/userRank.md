...
NipoPlusのスタッフアカウントには、それぞれ「権限」が設定されます。この権限によって、NipoPlusでできることや表示される画面が異なります。
...
- [グループの作成・削除](/nipoplus/admin/about/)
- [スタッフの作成・削除](/nipoplus/reference/makestaff/)
- スタッフの権限変更
- NipoPlusの[料金プランの管理](/nipoplus/price/)
- 組織設定画面へのアクセス
...
詳しくは[グループ設定](/nipoplus/editor/groupmanage/)を御覧ください。
...
:::caution[ゲスト権限は現在非推奨]
上位互換となる[外部入力機能](/nipoplus/reference/outsidewrite/)がサポートされたため、ゲスト権限を使用するメリットは現在ありません。
:::
...
しかし前述の通りログインすら不要でアンケート回答に使える[外部入力機能](/nipoplus/reference/outsidewrite/)の登場により、この権限は静かに役目を終えようとしています。
