...
![管理者権限を持つユーザーの画面には、組織全体の管理を行うための「組織設定」メニューが表示されます。](./img/admin_tablet.webp)
...
![グループ設定にアクセスするには編集者権限以上が必要だよ](./img/manager_tablet.webp)
...
![スタッフ権限の画面では、設定に関するメニューは表示されません。日報作成や閲覧に特化したシンプルな画面です。](./img/staff_tablet.webp)
