...
:::tip[提出者の特定は不可能]
ログインしていないため誰が書いたかはわかりません。名前を知る必要がある場合はテンプレートを工夫して名前フォームも追加しておきましょう
:::

## 外部共有から作成された日報を読む {#readReport}

外部共有機能で作成された日報（アンケート回答）は[受信BOX](/nipoplus/reference/searchreport/#listbox)から通常の日報と同じようにアクセス可能です。
