...
![プレビューで実際のフォームを確認しよう](./img/customerInputPreview_tablet.webp)
...
![難しいことを考えずにシンプルに探そう](./img/simpleSearch_tablet.webp)
...
![例えば性別が女性の顧客だけを見つけたいときに使うよ](./img/customerFilter1_tablet.webp)
...
![ふりがなで検索してみましょう](./img/fulltextSearch_tablet.webp)
...
![これで顧客管理マスターですね](./img/multiSearch_tablet.webp)
...
![顧客の応対履歴を時系列で見れるよ](./img/customerLog_tablet.webp)
...
![予定として登録をONにしよう](./img/makeCustomerSchedule_tablet.webp)

「提出」ボタンを押すと顧客対応メモが「予定」ステータスの状態で登録されます。予定データは予定時刻を持っているため、顧客対応メモの履歴や、カレンダーから予定時刻を確認出来ます。

![顧客対応のタイムライン上に予定として表示されるよ](./img/customerTimeline_tablet.webp)
...
![カレンダーと連携してスケジュール管理としても使えるよ](./img/customerCalendar_tablet.webp)
...
![カレンダー上にメモを表示すればスケジューラーとしても使えるよ](./img/customerMemoCalendar_tablet.webp)

## 顧客メモ詳細表示について {#report_details}

一覧から１つの顧客メモをクリックすると詳細表示に切り替わります。

![メモ詳細画面だよ](./img/customerMemoDetail_tablet.webp)
