...
![案件を新規作成しましょう。案件は日報をまとめる箱のようなイメージです](./img/anken-add_tablet.webp)
...
![案件に紐づけられた日報は案件名が右上エリアに表示されます](./img/read-report-anken_tablet.webp)
...
![案件一覧では紐づいた日報の件数や案件状態を確認できます](./img/anken-list_tablet.webp)
...
![案件一覧から案件を開くと詳細を見れます。とはいえ紐づいた日報くらいですが・・・](./img/anken-detail_tablet.webp)
...
![列見出しに案件名が入るので累積を見たい場合に便利な機能です。](./img/anken-sumtotal_tablet.webp)
