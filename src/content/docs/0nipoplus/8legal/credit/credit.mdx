...
title: NipoPlusの権利・クレジット｜画像の転載規約と使用技術一覧
description: 本Webサイトに使用されている画像の取り扱いについて記載しています。NipoPlusの画像は転載可能です
sidebar:
  label: 権利・クレジット
---

## 本サイトに使用されている画像の利用について [#id=image_use]

### NipoおよびNipoPlusの画像利用 [#id=app_image_usage_guide]
...
### マスコットキャラクター「アリス」の画像利用 [#id=image_charactor_usage_guide]
...
本サイトで使用されている画像のすべてが当社のものと言うわけではありません。例えばGoogle Play StoreやAppStoreのロゴは各アプリストア元が画像を管理しています。

ご不明な点については[お問い合わせ](/inquery)ください。

---

## 本サイト・本アプリで使用している各種技術 [#id=site_tech]
...
<dl class="basic">
<dt><a href="https://astro.build">Astro</a></dt>
<dd>現在ご覧いただいているドキュメントサイトのベースとなる、高速な静的サイトジェネレータです</dd>
<dt><a href="https://starlight.astro.build">Starlight</a></dt>
<dd>現在のドキュメントサイトのメインテーマです。マニュアルやドキュメントに特化した美しいUIを提供してくれています</dd>
...
<dd>通信のやり取りをより簡単に行えるようにしてくれるソフトウェアです</dd>
...
<dd>indexedDBの複雑な操作を簡単にしてくれます</dd>
...
## Nipo【旧版】およびNipoPlusを取り上げてくれた方々 [#id=medias]

- Senses Lab様[おすすめ日報アプリ・ツールの7選を比較 | 価格（無料あり）・特徴](https://product-senses.mazrica.com/senseslab/tool-reviews/nippou-software)
- BOXIL 様[日報をアプリで！クラウド日報ツールまとめ](https://boxil.jp/mag/a1499)
- melma 様[ＩＴでらくらく建設業 Vol.714](http://melma.com/backnumber_114938_6635216)
- ITでらくらく建設業様[日報サービス・アプリ](http://mint-s.jp/it-easy/2018/01/post-2127.html)
- 人事評価制度の教科書様[日報業務を効率化すれば残業も減る!外出先でも使える日報管理ツール6個](https://media.jinjiseido.com/nippou_tool)
- Tab-biz 様[業務日誌とは・書き方とフォーマット例・おすすめアプリ](https://tap-biz.jp/tap_cat_100401/tap_cat_100405/1014295)
- 情シス様 日報業務を効率化する日報管理ツール7選まとめ （サイト閉鎖？リンクぎれ）
- B2B ハッカー 様[無料から使える!営業日報管理ツール5選](https://b2bhacker.baseconnect.in/articles/2611)

### Nipo【旧版】ご利用のお客様からのご紹介 [#id=special_thanks]
