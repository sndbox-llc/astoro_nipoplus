...
- 写真入力フォームに添付する画像を[無料プラン](/nipoplus/price/free/)では低画質化させました（容量節約のため[無料プラン](/nipoplus/price/free/)の方には申し訳ございません）
- [反復入力](/nipoplus/template/array/)内に日付と時刻フォームでカレンダーを表示するとレイアウトが崩れるバグを修正しました
- 日報のロード件数を[有料プラン](/nipoplus/price/invoice/)限定で上限1000件に引き上げました
...
- [無料プラン](/nipoplus/price/free/)でPDF出力時、NipoPlusの透かしとフッターロゴが強制的に挿入されます（サーバサイド）
- [PDF出力オプション](/nipoplus/staff/pdf/)に「文字サイズ：XS」が追加されました
- PDF出力オプションに「ページ番号」が追加されました
- PDF出力オプションに「余白：最小」が追加されました
- 一括PDF出力が[無料プラン](/nipoplus/price/free/)でも利用可能になります（無料プラン：５件まで・有料プラン：８０件まで）
...
- 商品データ一括インポートが[有料プラン](/nipoplus/price/invoice/)限定になりました
- クレジットカードの有料プラン申し込み最少人数が5名に変更されました（請求書払いはもうしばらくお待ち下さい）
- グループの作成上限を変更しました。[無料プラン](/nipoplus/price/free/)： 3件まで 有料プラン: 500件まで
- グループ内のタグの上限を変更しました。 [無料プラン](/nipoplus/price/free/): 5件まで 有料プラン: 200件まで
- グループ内のテンプレートの上限を変更しました。 [無料プラン](/nipoplus/price/free/)：5件まで 有料プラン: 999件まで（変更なし）
- 商品の登録上限を変更しました。 [無料プラン](/nipoplus/price/free/)：300件まで 有料プラン: 99999件まで
...
- [メール通知機能](/nipoplus/reference/notify/#email)を実装しました。月50通まで無料です（無料プランは利用不可）。オプション開放で月10,000通まで発信可能になります
...
- [無料プラン](/nipoplus/price/free/)の利用人数が5名→4名に変更されました
- PDF一括DL機能のバグを修正しました
...
- スライダーパーツが追加されました
- 選択肢や数値など、一部のGOLDPLAN限定としてきたパーツを無料プランでも利用可能としました
