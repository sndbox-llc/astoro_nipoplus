...
- 書きかけの日報を復元する機能をGOLD PLAN限定とさせていただきました
...
- [日報の入力順序を制御](/nipoplus/template/make/)できるようになりました
...
- クレジットで[GOLD PLAN](/nipoplus/price/subscription/)お申込み時、会社名の記入が必須になりました
...
- [テンプレート](/nipoplus/template/make/)一覧をリストモード、カードモードの切替表示が可能になりました
...
- [日報テンプレート](/nipoplus/template/make/)のラベルを色分けできる機能が追加されました
...
#### 【Nipo(旧)】 2021/8/30 v6.6.0 {#v6.5.8}
