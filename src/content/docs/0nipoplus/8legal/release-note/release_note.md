...
- 無料PLANでも検索機能が利用できるようになりました（無料PLAN中に書いた日報はインデックス化されないため検索にHitしません。有料プランの間に書いた日報が検索できます）
...
- 一括PDF出力が[無料PLAN](/nipoplus/price/free)でも利用可能になります（無料PLAN：５件まで・有料プラン：８０件まで）
...
- グループの作成上限を変更しました。[無料PLAN](/nipoplus/price/free)： 3件まで 有料プラン: 500件まで
- グループ内のタグの上限を変更しました。 [無料PLAN](/nipoplus/price/free): 5件まで 有料プラン: 200件まで
- グループ内のテンプレートの上限を変更しました。 [無料PLAN](/nipoplus/price/free)：5件まで 有料プラン: 999件まで（変更なし）
- 商品の登録上限を変更しました。 [無料PLAN](/nipoplus/price/free)：300件まで 有料プラン: 99999件まで
