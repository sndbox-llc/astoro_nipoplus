...
APIのエンドポイントに[タイムカードのエンドポイント](/docs/reference/api/#timecard)を追加しました。
...
- 日報を[アカウントが無くても作成できる外部共有機能](/docs/reference/outsidewrite/)が実装されました
- 日報を[アカウントがなくても読める外部共有機能](/docs/reference/outsideread/)が実装されました
- [日付と時刻入力フォーム](/docs/template/date_time/)で西暦を含む日付の場合、曜日が表示されるようになりました

#### 【NipoPlus】 2025/2/6 サーバサイドアップデート {#server20250206}

- 書き込みのみ[権限](/docs/reference/userRank/)のスタッフも自分の書いた日報のPDF出力ができるように修正しました

#### 【NipoPlus】 2025/1/29 v1.68.0 {#vp1_68_0}

- [日報の引継機能](/docs/reference/relation/)が実装されました
- [通知](/docs/reference/notify/)に「引継」の項目が追加されました
...
- [PDF出力オプション](/docs/staff/pdf/)に「エラーや警告を出力する」の設定が追加されました（初期状態：OFF。従来はこれが常にONの状態でした）
- PDF出力時に押印される名前ハンコの最大文字数が5文字から10文字に拡張されました
- [PDF出力にレイアウト2](/docs/staff/pdf/#layout)が追加されました
...
- [日報受信BOX画面](/docs/reference/searchreport/#listbox)に「再読み込み」ボタンを追加しました
...
- [CSV出力時](/docs/reference/csvsettings/)、文書番号のまえに文書番号プレフィックスもセットで出力されるようになりました
- [目標実績テーブル](/docs/reference/progress/)で、スマートフォンやタブレットのタッチイベントでも幅変更できるように修正しました
- 日毎カレンダー表示で１時間毎の水平線が追加されました

#### 【NipoPlus】 2024/7/22 v1.58.0 {#vp1_58_0}

- [CSV出力オプション](/docs/reference/csvsettings/)に「文書番号」出力オプションが追加されました
...
- 日報のロード件数を[有料プラン](/docs/price/invoice/)限定で上限1000件に引き上げました
...
- [PDF出力時](/docs/staff/pdf/)、オプション設定をすると特定のデータが消えて出力されるバグを修正しました
...
- [日報作成画面](/docs/staff/writereport/)で一番下まで一気にスクロールできるボタンを追加しました（初期状態では無効になっています。「左メニュー ＞アカウント ＞ 日報作成画面でページ下部へスクロールするボタンを配置する 」をONにすることで利用できます
- [タイムカード](/docs/reference/timecard/)の打刻時、これまで初期値が8:00 - 17:00で固定でしたがこれを自由に変更できるようになりました
- タイムカードの設定をリアルタイム反映ではなく、保存ボタン押下で反映されるように仕様を変更しました
- 日報作成で[共用機能](/docs/reference/staffshare/)にバグがありましたのでこちらを修正しました（報告ありがとうございます）
...
- [CSV出力オプション](/docs/reference/csvsettings/)に 非可変を可変に合わせて同値で埋める を追加しました
...
- [日報作成](/docs/staff/writereport/)の途中でページを移動しようとすると、警告が表示されるように修正しました
- [日報作成](/docs/staff/writereport/)の途中でページを離脱した時、一部のデータの復元ができないバグを修正しました
- 「既読して次へ」ボタンを追加しました
- 日報を既読しても日報一覧に「既読」の状態がつかないバグを修正しました
- [日報をコピー作成](/docs/reference/copymake/)する時、提出先がコピー時のままでしたが、提出先の設定に沿うように修正しました
...
- [目標実績表](/docs/reference/progress/)の作成画面をわかりやすく改善しました
- わかりにくい箇所のヘルプガイドを追加しました

#### 【NipoPlus】 2024/5/28 v1.53.0 {#vp1_53_0}

- スタッフ毎の提出先設定画面のUIを使いやすく大幅に改善しました
- [PDF出力時の設定オプション](/docs/staff/pdf/)を目立つ位置に移動しました
...
- [予定実績管理](/docs/reference/progress/)でCSVが正しく出力されないバグを修正しました
- 日報の[CSV出力オプション](/docs/reference/csvsettings/)に「案件出力」が追加されました
...
- [PDF出力オプション](/docs/staff/pdf/)に「文字サイズ：XS」が追加されました
...
- 日報保存BOXのUIを変更しました。詳しいガイドは[保存BOX](/docs/reference/searchreport/#listbox)を御覧ください。
...
新機能のマニュアルについては後日日を改めてUPいたしますー＞[マニュアルはこちら](/docs/other/schedule/)
...
- アカウントの[一括作成機能](/docs/reference/makestaff/#batch_create)がサポートされました
- [シフト管理](/docs/reference/shift/)がサポートされました
...
- CSVダウンロード時にスタッフごとやテンプレートごとに個別に分けてダウンロードできるようになりました。[【詳細はこちら】](/docs/staff/csv/#splid_download)
- [タグの管理画面](/docs/editor/tagManagement/)で分類による絞り込みをサポートしました
...
- 商品データ一括インポートが[有料プラン](/docs/price/invoice/)限定になりました
...
- 新しい集計方式[【予定・実績表】](/docs/reference/progress/)が追加されました
...
- [API](/docs/reference/api/)機能の利用を管理者がスタッフごとに制御できるようになりました。初期値はすべて「無効」扱いとなります。
...
- [ログ機能](/docs/reference/log/)でスタッフIDだとわかりにくいためスタッフ名を表示するように修正しました
- [スタッフアカウント](/docs/reference/userRank/)を「無効」にすると利用人数から減るように修正しました

#### 【NipoPlus】 2023/04/02 v1.35.0 {#vp1_35_0}

- [商品データ](/docs/editor/inventory/)の一括CSV出力をサポートしました
- [商品データ](/docs/editor/inventory/)の数量推移CSV出力をサポートしました
...
- [集計・CSV出力ページ](/docs/reference/transition/)のレイアウトを一部変更しました

#### 【NipoPlus】 2023/03/24 v1.34.1 {#vp1_34_1}

- [タグ管理](/docs/editor/tagManagement/)機能について項目ごとに使い分けができるように機能が強化されました
- タグのアイコンがゴミ箱になるバグを修正しました
- [週カレンダー](/docs/reference/calendar/)でスタッフの並び順を変更するウインドウに「閉じる」ボタンを追加しました
...
- [スタッフごとに利用可能な日報テンプレート](/docs/reference/makestaff/)を指定できるようになりました
...
- [受信BOX](/docs/reference/searchreport/#listbox)で初期の表示期間を3日・1週間・2週間から選べるようになりました
- 組織設定の画面周りを微調整しました

#### 【NipoPlus】 2023/02/24 v1.31.0 {#vp1_31_0}

- [メール通知機能](/docs/reference/notify/#email)を実装しました。月50通まで無料です（無料プランは利用不可）。オプション開放で月10,000通まで発信可能になります
...
- クレジットで[GOLD PLAN](/docs/price/subscription/)お申込み時、会社名の記入が必須になりました
...
- 異なるテンプレート間の集計を行える機能（[クロス集計](/docs/reference/cross/)と命名）を実装しました
...
- [スタッフ権限](/docs/reference/userRank/)に「ゲスト権限」が追加されました（リクエスト）
...
- （[組織全体設定](/docs/reference/makestaff/)）スタッフ管理の画面切替機能を追加しました
...
- [グラフ作成機能](/docs/reference/chart/)が実装されました
...
- [過去データ推移](/docs/reference/transition/)の色分け機能にバグがあったため修正を行いました。（すでに設定済みの場合、設定はクリアされます）

#### 【NipoPlus】 2022/09/13 v1.13.0 {#vp1_13_0}

- [過去データ推移](/docs/reference/transition/)で最大取得件数を10件から30件に拡張しました。（オプションから選択します）
- 過去データ推移で各行ごとに任意の色付けをすることが出来るようになりました
- スタッフのアカウントを無効化するとAPIキーも同時に破壊されるように修正しました
- 手動で[APIキーを破壊](/docs/reference/api/#disable)できる機能を追加しました
...
- [CSV出力](/docs/staff/csv/)時、バイナリの出力をスタッフ名ごとにフォルダ分けして出力するように修正しました
- [ログ表示](/docs/reference/log/)の日付入力を使いやすく改良しました
...
- [CSV出力](/docs/staff/csv/)オプションに「画像の出力」「コメントの出力」が追加されました
...
- [CSV出力](/docs/staff/csv/)オプションに「反復入力」に関するオプションが追加されました
- [反復入力の日報](/docs/template/array/)のデザインを変更しました

#### 【NipoPlus】 2022/08/16 v1.10.0 {#vp1_10_0}

- [匿名アカウント](/docs/reference/tokumei/)によるログインがサポートされました（Web版限定）
- [ログアウト](/docs/reference/account/)時にエラーメッセージが表示されるバグの修正を行いました

#### 【NipoPlus】 2022/08/13 v1.9.0 {#vp1_9_0}

- [PDF出力機能](/docs/staff/readreport/#pdf_export)が強化されました
- [一括PDF](/docs/staff/pdf/)・QRコード埋め込み・本文の編集などが可能になりました
...
- [CSV出力](/docs/staff/csv/)に「昇順出力」オプションが追加されました
...
- 日報の[CSV出力オプション](/docs/staff/csv/)が変更されました

#### 【NipoPlus】 2022/07/07 v1.5.3 {#vp1_5_3}

- 過去データ推移の1列目を固定にしました
- 日報の修正後に続けて日報を書くと上書きされてしまうバグを修正しました
- 特定の環境で過去の[データ推移](/docs/reference/transition/)が取得できないバグを修正しました
- [共用機能](/docs/reference/staffshare/)について提出先の指定が適用されないバグが確認されたため修正を行いました
- [グループへの所属画面](/docs/reference/makestaff/)をより見やすく変更しました
...
- [CSV出力設定が保存可能](/docs/staff/csv/)になりました
...
- 提出専用アカウントでも[自分の日報に限り集計](/docs/staff/charts/)できるようになりました
...
- [選択肢(複)](/docs/template/selects/#multiple)の[集計](/docs/reference/transition/)が行われないバグを修正しました
