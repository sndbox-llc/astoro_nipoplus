...
| 2024/08/27 | 要望     | [API](/docs/reference/api/)操作でPDF出力やCSV出力をしたい                                                       |
...
| 2024/07/09 | 要望     | [API](/docs/reference/api/)機能、数値の単位も含めて出力                                                         | 保留                                            |
| 2024/07/09 | 要望     | [API](/docs/reference/api/)機能、テンプレートごとに並べて出力                                                   | 保留                                            |
...
| XXXX/XX/XX | 改善     | [メール通知機能](/docs/reference/notify/#email)の実装                                                           | [1.31.0](/docs/system/release-note#vp1_31_0)    |
| XXXX/XX/XX | バグ     | テンプレートコピー時に提出先情報なども含めてコピーを行う                                                        | [1.29.0](/docs/system/release-note#vp1_29_0)    |
| XXXX/XX/XX | 改善     | テンプレートを横断した[交差集計機能](/docs/reference/cross/)の実装                                              | [1.28.0](/docs/system/release-note#vp1_28_0)    |
