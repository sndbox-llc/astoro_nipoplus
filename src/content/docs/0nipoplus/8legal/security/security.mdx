...
## 1．Google Cloud Platform (GCP) が支える強固な基盤 [#id=gcp_infrastructure]
...
### GCPの主なセキュリティ特徴 [#id=gcp_security_features]
...
## 2．厳重な認証システムとデータ暗号化 [#id=auth_and_encryption]

お客様のNipoPlusへのアクセスや、データの保管には、さらに高度なセキュリティ技術が用いられています。

### Firebase Authenticationによる安全な認証 [#id=firebase_auth]
...
### 機密情報の徹底した暗号化 [#id=data_encryption]
...
### NoSQLデータベースによる構造的安全性 [#id=nosql_security]
...
## 3．お客様自身によるアカウント保護のお願い [#id=user_account_protection]
...
## 4．セキュリティに関するよくあるご質問（FAQ） [#id=security_faq]
...
<details>
  ...
  はい、安全です。Google Cloud Platformのデータセンターは、物理的・論理的に最高水準のセキュリティ対策が施されています。
  <a href="https://firebase.google.com/terms/data-processing-terms?hl=ja#1.-data-center-and-network-security" target="_blank">
    Firebase公式サイトのデータセンターに関する情報
  </a>
  もご参照ください
</details>
...
<details>
  ...
  はい、安全です。通信回線はすべて暗号化（HTTPS）されており、データの盗聴や改ざんを防ぎます。
  <a href="https://firebase.google.com/terms/data-processing-terms?hl=ja#1.-data-center-and-network-security" target="_blank">
    Firebase公式サイトのネットワークセキュリティに関する情報
  </a>
  もご参照ください。
</details>
...
<details>
  ...
  いいえ、パスワードの定期的な変更は行っていません。現代のセキュリティ基準では、定期的なパスワード変更はむしろ推奨されておらず、
  <a href="https://www.soumu.go.jp/main_sosiki/cybersecurity/kokumin/security/business/staff/06/" target="_blank">
    総務省
  </a>
  なども推奨していません。
</details>
...
<details>
  ...
  いいえ、物理的な施錠や盗難防止チェーンは使用していません。代わりに、
  <a href="https://support.apple.com/ja-jp/HT204837" target="_blank">
    ストレージは強力に暗号化
  </a>
  されており、データ保護を徹底しています。
</details>
