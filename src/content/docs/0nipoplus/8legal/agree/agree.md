...
ユーザーは，本サービス利用の対価として，当社が別途定め，[ウェブサイト](/nipoplus/price/)に表示する利用料金を，当社が指定する方法により支払うものとします。
...
また、お客さまからお預かりしたプライバシーポリシーについては[プライバシーポリシー](/nipoplus/system/privacy-policy/)のページをご確認ください
