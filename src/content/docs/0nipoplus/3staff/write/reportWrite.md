...
日報作成ボタンをクリックすると、使用可能なテンプレートの一覧が表示されます。
...
:::tip[タグも使えます]
日報作成画面でタグが表示されている場合はタグを付けて日報を提出することもできます。[検索や目印](/nipoplus/reference/searchreport)にもなるので積極的に活用して下さい
:::
