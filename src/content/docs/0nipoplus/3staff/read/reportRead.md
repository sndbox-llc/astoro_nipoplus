...
![ダウンロードしたPDFファイルは、ブラウザで直接表示されたり、PCに保存されたりします。これはブラウザ表示の例です](./img/pdf-download_tablet.png)
...
![表示した画面](./img/reportView_tablet.webp)
...
![表紙以外の日報は警告が出ます](./img/reportWarning_tablet.webp)
