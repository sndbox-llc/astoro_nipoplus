...
:::note[[無料プランでは背景に透かしが入ります](/legacy/system/price/)]
:::
...
![PDF出力時の設定画面は折りたたまれているためクリックで展開](./img/pdf-setting-ini_tablet.png)
...
![PDF出力の設定が可能です。この設定は１回きり有効](./img/pdf-option_tablet.png)
