...
- [GOLDプラン（自動更新有り）](/docs/price/subscription)に申し込む
...
[月額払い（自動更新有り）はこちら](/docs/price/subscription/)

[都度払い（自動更新無し）はこちら](/docs/price/invoice/)

## 現在のプランを確認する {#current_plan}

あなたの組織がどのプランかを確認してみましょう。

1. [左メニューから組織設定をクリック](/docs/admin/about/#adminPage)
...
| ✅[NipoPlus](/docs/admin/quickstart/)              |                                180円 |                                  5名 | <span style="color:red;background-color:pink;">900円</span> | 無料有                           |
...
スタッフが全員自分たちのスマートフォンから[日報を書く](/docs/staff/writereport/)場合は、使用する端末数＝スタッフの人数となるため、スタッフ人数分のお申し込みをお願いします。
...
可能です。稼働のない期間は無料プランに切替えていただくことで、使用しない間のコストを抑制できます。解約忘れを防ぐため、<a href="/docs/price/invoice/">請求書払い</a>がおすすめです。
...
<details>
<summary>回答を表示する</summary>
いいえ。掛かりません。年会費や会員維持費、基本使用料など、名称を変えたその他の費用も一切ありません。ただし<a href="/docs/price/invoice/">請求書払い</a>の場合、決済時に掛かる口座振込手数料はご負担ください。請求書をクレジットカードでお支払いいただく場合、この手数料も掛かりません。
</details>
...
<details>
<summary>回答を表示する</summary>
アプリ上から<a href="/docs/price/receipt/">領収証</a>の発行が可能です
</details>
...
<details>
<summary>回答を表示する</summary>
いいえ。<a href="/docs/reference/timecard/">タイムカードの制限解除</a>は１度のお支払いで組織に所属している全スタッフ分のタイムカードが解除されます。その後に追加されたスタッフも全て解除されます
</details>
