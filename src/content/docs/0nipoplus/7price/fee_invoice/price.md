...
**自動更新あり**のクレジットカード払いをご希望の場合は、[こちらのお申込みページ](/nipoplus/price/subscription/)をご覧ください。
:::

:::caution[【重要】お申し込み前にご確認ください]
...
金額は人数と期間で決まり、1名1ヶ月200円です。[自動更新ありのプラン](/nipoplus/price/subscription/)と比較して若干割高になります。
...
![オンライン請求書からPDF版のダウンロードや、支払い方法の選択が可能です](./img/invoice-online_tablet.png)
...
- 支払い後2営業日以上経過しても有料プランに切り替わらない場合は、[お問い合わせ](/inquery/)ください。
...
データが不要な場合は、手動で削除してください。最も迅速にデータを消すには[退会処理](/nipoplus/reference/withdrawal/)を行う方法があります。
...
![契約期間中の人数変更に伴う過不足は残存期間で調整されます](./img/change-member-limit_tablet.png)
