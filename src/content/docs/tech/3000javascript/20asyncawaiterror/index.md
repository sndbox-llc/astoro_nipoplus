...
![async・awaitでエラー時に処理が止まらない](./img/console-log-screen.png)
...
![async関数の呼び出し元で正しくエラーをキャッチできた](./img/error-chatch.png)
...
![errorオブジェクトをnewErrorで包むと扱いにくくなる](./img/over-lap-error.png)
...
![finally句が正常に実行されていることが確認できる](./img/console-log-finally.png)
