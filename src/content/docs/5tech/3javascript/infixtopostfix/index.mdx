...
## 逆ポーランドの式を計算する [#id=calc_r_polish]
...
## 逆ポーランド記法はシンプルに計算できるし拡張しやすい [#id=enjoy_r_polish]
