...
実際のコードは次の通り。テンプレート部分。canvasタグにrefをもたせて、プログラム部分からも使えるように紐付けします。
...
![chart.jsを使って棒グラフを作成](./img/bar_chart.png)
...
![chart.jsを使って棒グラフを作成](./img/chart_ts.png)
