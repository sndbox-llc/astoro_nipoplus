...
## Vue-chart.jsを使わずにグラフを作ってみる [#id=create_graph_without_using_vue_chart_js]
...
## TypescriptとChart.js [#id=typescript_and_chartjs]
...
## Vue-Chart.jsは不要です。意外と簡単に実装できたChart.js [#id=chartjs_instead_of_vuechartjs]
