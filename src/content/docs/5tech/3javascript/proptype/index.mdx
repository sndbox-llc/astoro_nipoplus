...
## Interfaceを使って型を指定する？ [#id=using_interfaces_to_specify_types]
...
## type: Object as PropType &lt;型&gt;を使う [#id=use_object_as_proptype]
...
## TypeScriptはなれるまで大変だけど便利 [#id=typescript_challenging_but_useful]
