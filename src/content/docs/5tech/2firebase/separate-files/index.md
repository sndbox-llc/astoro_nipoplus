...
### 見逃しちゃいけないポイント‼️Cloud Functionsはセキュリティルールを素通りできます {#meta_rule}
...
slug: 'https://salonkarte-87b6a.firebaseio.com',
})
// ↑ここまではほぼ定型文
...
:::note[ファイルの分け方はいくつかあるようです。自分流にアレンジしてください]
:::
