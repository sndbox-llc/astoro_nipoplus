...
description: Firebaseを使用して、ユーザが登録したE-mailアドレスが正しいかを確認する方法を詳しく紹介します。メール認証機能を利用して、簡単にE-mail確認プロセスを実装可能です。
sidebar:
...
## currentUser.emailVerified [#id=emailVerified]
...
## 認証が終わってないなら認証メールを投げる [#id=send_verify_email]
