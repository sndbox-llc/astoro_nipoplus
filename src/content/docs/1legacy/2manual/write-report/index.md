...
![使用するテンプレートを選択しよう](./img/chooseTemplate_tablet.webp)
...
![日報記入画面。選んだテンプレートによって項目が変わります](./img/writeReport_tablet.webp)
...
![受信BOXの画面例。新着順に並びます](./img/reportOrderby_tablet.webp)
