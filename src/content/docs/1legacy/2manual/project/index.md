...
![プロジェクトを有効にします](./img/enableProject_tablet.webp)
...
![プロジェクト画面から日報作成するとプロジェクト情報が自動でセットされるよ](./img/makeReport_tablet.webp)

内容を書き上げて、提出ボタンを押すと、当該日報が「プロジェクト」として保存されます。
また、通常の受信一覧にも登録されます。

![日報が提出されるとボタンが日報へのリンクに変わります](./img/projectWrited_tablet.webp)
...
![完了や破棄など状態を変更できます](./img/projectStatus_tablet.webp)
