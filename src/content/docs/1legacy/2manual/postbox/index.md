...
さて、日報の一覧表示はおおよそこのくらいです。画面左の日報一覧から任意の日報をクリックして、日報の詳細表示に切り替えます
...
削除は[送信BOX](/nipoplus/gainen/reportStorage/#outbox)から削除したいレポートを表示し、削除ボタンを押すことで削除できます。
...
修正したい日報を[送信BOX](/nipoplus/gainen/reportStorage/#outbox)から表示し、編集ボタンをクリックします
