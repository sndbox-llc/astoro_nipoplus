...
![サインイン画面です](./img/signup_tablet.webp)
...
![グループの作成からはじめましょう。グループ名を決めるだけですぐ作れます](./img/makeGroup_tablet.webp)
...
![まずは名前を入力しよう](./img/wizard1_tablet.webp)
...
![スタッフを追加します](./img/makeStaff_tablet.webp)
...
![編集したいテンプレートを選択します](./img/templateEdit_tablet.webp)

テンプレートの編集画面が開きました。

![テンプレートの編集画面です](./img/templateEditor_tablet.webp)
