...
![請求書払いは完全先払いです](./img/invoice_tablet.webp)
...
![オンライン請求書です](./img/payment_method_tablet.webp)
...
![人数変更は月3回まで。今まで不可能だった人数減少もできるようになったよ](./img/edit-member-limit_tablet.webp)
...
![サブスクリプションの解約や変更はここから操作します](./img/subscription-edit_tablet.webp)
...
![オンライン領収証からダウンロードできます](./img/receipt2_tablet.webp)
...
![「課金を停止」ボタンを押します](./img/stop-subscription_tablet.webp)
